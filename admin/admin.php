...
<html>
	<head>
		...
		<title>ADMIN - Pemilihan PresMa 2013 | STMIK RAHARJA</title>      
	</head>
<body>
	<div class="navbar">
...
<tr><td>Belum Memilih</td> <td>:</td> <td><?php echo $belummemilih;?></td></tr>
	...
	//md5
	$md5=md5($password);
	$maskedPassword = str_repeat("*", strlen($md5));
	...
	<td><a href=\"edit.php?id=$r[0]\"onclick=\"return confirm('Apakah anda yakin akan mengubah data pemilih yang bernama $nama ?')\" title=\"Edit data $nama\"><img src=\"../img/edit.png\"></a> | <a href=\"hapus.php?id=$r[0] \"onclick=\"return confirm('Apakah anda yakin akan menghapus?')\" title=\"Hapus data $nama\"><img src=\"../img/delete.png\"></a></td></tr>";
	$no++;
	}
	?>
</div>
</br>
<a href="tambahpemilih.php">Tambah Pemilih</a> | <a href="lihat.php">Statistik</a></br></br>
</body>
</html>